...
WHERE    hly.FISCAL_WEEK_ID = 202023
...
WHERE    sly.FISCAL_WEEK_ID in (202022, 202023)
...
FROM     WH_OWNER.DCLBR_WK_LOC dwl
         ...
         inner join WH_OWNER.FISCAL_WEEK fw on dwl.FISCAL_WEEK_ID = fw.FISCAL_WEEK_ID AND fw.FISCAL_WEEK_ID = 202023 --(fw.START_DT >= date(date('#CURRENT_DATE_DB2#') - (date_part('dow', date '#CURRENT_DATE_DB2#')+6)) And fw.END_DT <= date(date(current date) - (date_part('dow', date current date)- 0)))
...
WHERE    (hd.S_GL_DEPT_ID in ('8100', '8105', '8110') --, '8160', '8500', '8115', '8116', '8117', '8716', '8717')
     ...
     AND dwl.EARNINGS_CD in ('035', '040', '050', '100', '35O', 'FLS', 'FNL', 'FRG', 'HLH', 'HLS', 'HLX', 'HPN', 'HXP', 'INC', 'IND', 'JRY', 'MOP', 'MTG', 'NET', 'NPO', 'NPR', 'OT1', 'PER', 'PHS', 'PIO', 'PIP', 'PPH', 'PPX', 'RAD', 'REG', 'RG+', 'RTO', 'SDH', 'SDS', 'SIC', 'SKH', 'SKP', 'SKS', 'SKT', 'SST', 'TAD', 'TRA', 'TRN', 'VAB', 'VAC', 'VAP', 'VAS', 'VAT', 'VBP', 'VBS', 'VBY', 'AAB', 'FLB', 'FLP', 'FLU', 'IFP', 'WRP')
...
OR       (hd.S_GL_DEPT_ID in ('8100', '8105', '8110') --, '8160', '8500', '8115', '8116', '8117', '8716', '8717')
     ...
     AND dwl.PAY_GROUP_CD not in ('SAL', 'SLY')
     AND dwl.EARNINGS_CD in ('015', '025', '030', '035', '040', '050', '100', '15O', '1OT', '25O', '35O', '40O', 'FAV', 'FLD', 'FPD', 'FPO', 'FRZ', 'GAR', 'GRO', 'GRV', 'ICV', 'INC', 'LPD', 'LPO', 'LPY', 'LSC', 'LSI', 'MID', 'MIN', 'MIO', 'MTG', 'NET', 'NPD', 'NPO', 'NPR', 'OAD', 'OLA', 'OT1', 'OT2', 'PIO', 'PIP', 'RAD', 'RBN', 'REG', 'RG+', 'RTO', 'SDH', 'TAD', 'TRA', 'TRN', 'AAB', 'FLB', 'FLP', 'FLU', 'IFP', 'WRP')
     AND dwl.LOCATION_CD in ('2007', '2016', '2037', '2038', '2040', '2052', '2054', '2915', '2058', '2067', '2071', '2917', 'GGM', 'GGR', 'GPR', 'VSPT')
)
) hly
group by 1, 2, 3
...
FROM     WH_OWNER.DCLBR_WK_LOC dwl
         ...
         inner join WH_OWNER.PS_HR_DEPT hd on dwl.DEPT_ID = hd.DEPT_ID
         inner join WH_OWNER.PS_HR_JOB hj on dwl.JOB_CD = hj.JOB_CD
         inner join WH_OWNER.FISCAL_WEEK fw on dwl.FISCAL_WEEK_ID = fw.FISCAL_WEEK_ID AND fw.FISCAL_WEEK_ID between 202022 and 202023  --(fw.START_DT >= date(date('#CURRENT_DATE_DB2#') - (date_part('dow', date '#CURRENT_DATE_DB2#')+6)) And fw.END_DT <= date(date(current date) - (date_part('dow', date current date)- 0)))
         left outer join WH_OWNER.PS_HR_EARNINGS he on dwl.EARNINGS_CD = he.EARNINGS_CD
WHERE    (hd.S_GL_DEPT_ID in ('8100', '8105', '8110') --, '8160', '8500', '8115', '8116', '8117', '8716', '8717')
...
OR       (hd.S_GL_DEPT_ID in ('8100', '8105', '8110') --, '8160', '8500', '8115', '8116', '8117', '8716', '8717')
     ...
     AND dwl.PAY_GROUP_CD in ('SAL', 'SLY')
     AND dwl.EARNINGS_CD in ('015', '025', '030', '035', '040', '050', '100', '15O', '1OT', '25O', '35O', '40O', 'FAV', 'FLD', 'FPD', 'FPO', 'FRZ', 'GAR', 'GRO', 'GRV', 'HLH', 'HXO', 'HXP', 'ICV', 'INC', 'LPD', 'LPO', 'LPY', 'LSC', 'LSI', 'MID', 'MIN', 'MIO', 'MTG', 'NET', 'NPD', 'NPO', 'NPR', 'OAD', 'OLA', 'OT1', 'OT2', 'PIO', 'PIP', 'RAD', 'RBN', 'REG', 'RG+', 'RTO', 'SDH', 'TAD', 'TRA', 'TRN', 'AAB', 'FLB', 'FLP', 'FLU', 'IFP', 'WRP')
     AND dwl.LOCATION_CD in ('2007', '2016', '2037', '2038', '2040', '2052', '2054', '2915', '2058', '2067', '2071', '2917', 'GGM', 'GGR', 'GPR', 'VSPT')
)
) sly
group by 1, 2, 3
