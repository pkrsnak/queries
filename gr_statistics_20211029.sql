...
SELECT   i.FACILITY_ID, i.VENDOR_NBR, v.VENDOR_NAME,
         DG.DEPT_GRP_KEY,
         DG.DEPT_GRP_NAME,
         D.DEPT_KEY,
         D.DEPT_NAME,
         i.COMMODITY_KEY,
         i.ITEM_NBR, i.UNIT_UPC_NBR, i.CASE_UPC_NBR, i.ROOT_ITEM_DESC,
         i.CASE_PACK_QTY,
         i.MASTER_PACK_QTY,
         i.RETAIL_PACK_QTY,
         case 
...
FROM     WH_OWNER.DC_ITEM i 
         inner join WH_OWNER.DC_VENDOR v on v.FACILITY_ID = i.FACILITY_ID and v.VENDOR_NBR = i.VENDOR_NBR
