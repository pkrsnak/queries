...
--AND      sls.USDS_FLG = 'D'
and sls.FACILITYID = '008' 
and sls.ITEM_NBR_HS = '0181008'
...
WHERE    BILLING_DATE > '2016-09-01'
GROUP BY BILLING_DATE, FACILITYID, INVOICE_NBR
;

SELECT   *
FROM     CRMADMIN.T_WHSE_SALES_HISTORY_DTL
WHERE    BILLING_DATE = '2016-09-17'
;

/*
BILLING_DATE	FACILITYID	INVOICE_NBR	NUM_RECORDS
2016-09-17	040	9171338	10
2016-09-17	040	9171339	10
2016-09-17	040	9171340	5
2016-09-17	040	9171341	5
2016-09-19	058	1997733	31
2016-09-19	058	1997734	38
2016-09-20	058	1997735	29
2016-09-20	058	1997736	38
;
*/

select * from CRMADMIN.T_WHSE_CUST where FACILITYID = '040' and CUSTOMER_NO_FULL in ('21003257', '13258405');

SELECT   *
FROM     CRMADMIN.T_WHSE_ITEM
WHERE    FACILITYID = '001'
AND      ITEM_DESCRIP like '%TURK%'
;

Select * from whmgr.dc_sales_hst where transaction_date > '09-01-2016' and facility_id = 1 and item_nbr = 8453136
;

select * from whmgr.dc_item where facility_id = 1 and item_nbr = 742965
;