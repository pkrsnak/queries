...
SELECT   paa.DEAL_SOURCE,
         ...
         pal.ALLOW_DATE_EXP,
         pal.ALLOW_AMT
FROM     PATRICK_KRSNAK.PPA_ALLOWANCES_ACOUSTIC_VW paa 
         inner join PATRICK_KRSNAK.PPA_ALLOWANCES_LEGACY_VW pal on paa.DEAL_TYPE = pal.DEAL_TYPE and paa.FACILITY_ID = pal.FACILITYID and paa.ITEM_NBR = pal.ITEM_NBR_HS
