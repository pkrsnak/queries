...
GROUP BY sls.FACILITYID, sls.BILLING_DATE, sxref.STORE_ID, sls.INVOICE_NBR, rlxref.LAWDEPT -- ,lxref.LAWSON_ACCOUNT
...
--AND      sls.BILLING_DATE between '2014-05-18' and '2014-06-14'
AND      sls.BILLING_DATE between $start_date and $end_date
AND      sls.WHOL_SALES_CD in ('094', '015', '012', '150')
and 	 sls.FACILITYID <> '002' 
AND      sls.USDS_FLG = 'D'
AND      sls.RECORD_ID = '2'
