SELECT   'RDET' As RECORD_SOURCE,
         ...
         sls.INVOICE_NBR INVOICE_NBR, lxref.LAWSON_DEPT,
         rlxref.LAWDEPT FINANCIAL_DEPT, sls.CUST_OVRRDE_RTL_DEPT, itm.MERCH_CLASS, itm.MERCH_DEPT_GRP, itm.MERCH_DEPT_GRP_DESC, --lxref.LAWSON_ACCOUNT,
         sls.ITEM_NBR_HS, sls.UPC_CASE, sls.UPC_UNIT, sls.ITEM_DESCRIPTION,  
...
AND      sls.BILLING_DATE between '2014-11-30' and '2014-12-13'
--AND      sls.BILLING_DATE between '2014-06-15' and '2014-07-12'
--AND      sls.BILLING_DATE between $start_date and $end_date
--and ((itm.ITEM_NBR_HS in ('0047076', '0046717', '0046516', '0054833') 
--and sls.FACILITYID in ('003', '005' ))
--or  (itm.ITEM_NBR_HS in ('0046417', '0046490', '0046532') 
--and sls.FACILITYID in ('040', '009' ))
--or  (itm.ITEM_NBR_HS in ('0046417', '0054833', '0046490') 
--and sls.FACILITYID in ('008' )))
--and sls.INVOICE_NBR = 12030225
--and sxref.STORE_ID in (3799)
--and rlxref.LAWDEPT in (102, 103)
...
GROUP BY sls.FACILITYID, 
sls.BILLING_DATE, 
sxref.STORE_ID, 
sls.INVOICE_NBR, lxref.LAWSON_DEPT, sls.CUST_OVRRDE_RTL_DEPT, itm.MERCH_CLASS, itm.MERCH_DEPT_GRP, itm.MERCH_DEPT_GRP_DESC,
rlxref.LAWDEPT, sls.ITEM_NBR_HS, sls.UPC_CASE, sls.UPC_UNIT, sls.ITEM_DESCRIPTION  
